  ...
  return (
    <footer className="bg-berryGrey mt-20 py-12">
      <div className="container-pad grid md:grid-cols-3 gap-8 text-sm">
        <div><h3 className="font-heading mb-3">Newsletter</h3><form className="flex gap-2"><input className="px-3 py-2 rounded-xl w-full" placeholder="E-mail"/><button className="bg-softRed text-paper px-4 rounded-xl transition-colors hover:bg-fadedRed">Join</button></form></div>
